...
İPUCU: Active Record ilişkilendirmeleri hakkında daha fazla bilgi için "Active Record Associations":association_basics.html klavuzuna bakınız.
...
İPUCU: Routing (yönlendirme) hakkında daha fazla bilgi için "Rails Routing from the Outside In":routing.html klavuzuna bakınız.
...
Şimdi <tt>app/views/posts/show.html.erb</tt> görelini şöyle düzenleyebilirsiniz:
